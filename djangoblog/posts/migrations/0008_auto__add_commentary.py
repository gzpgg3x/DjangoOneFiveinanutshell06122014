...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'posts_commentary', (
            ...
            ('author', self.gf('django.db.models.fields.CharField')(default=u'The invisible man', max_length=50)),
        ))
        db.send_create_signal(u'posts', ['Commentary'])


    def backwards(self, orm):
        # Deleting model 'Commentary'
        db.delete_table(u'posts_commentary')
    ...
    models = {
        ...
        u'posts.commentary': {
            ...
            'author': ('django.db.models.fields.CharField', [], {'default': "u'The invisible man'", 'max_length': '50'}),
